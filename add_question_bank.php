...
if($_POST)
{
    ...
    $sql11="INSERT INTO `qbank`(`qid`, `email`, `streamcategory`, `streamname`, `subject`, `chapter`, `section`, `question`, `questiontype`, `supporting_img`, `op1`, `op2`, `op3`, `op4`, `answer`, `createdts`,`status`,`qpid`) VALUES (NULL,'$email','$stream_category','$stream_name','$subject','$chapter', '$section','$question','$question_type','{$imgData}','$op1','$op2','$op3','$op4','$answer',CURRENT_TIMESTAMP,'0','NULL')";
        ...
        // Add a new Question in table
            $sql11="INSERT INTO `qbank`(`qid`, `email`, `streamcategory`, `streamname`, `subject`, `chapter`, `section`, `question`, `questiontype`, `supporting_img`, `op1`, `op2`, `op3`, `op4`, `answer`, `createdts`,`status`,`qpid`) VALUES (NULL,'$email','$stream_category','$stream_name','$subject','$chapter', '$section','$question','$question_type','NULL','$op1','$op2','$op3','$op4','$answer',CURRENT_TIMESTAMP,'0','NULL')";
...
<div class="container">
    <form action="add_question_bank.php" method="post" enctype="multipart/form-data" class="form-inline">
        ...
        <div class="form-group col-lg-3" style="margin-bottom: 20px;">
            ...
            <select class="form-control" id="subject" name="subject" style="width: 300px;" required>
        ...
        <div class="form-group col-lg-3" style="margin-bottom: 20px;">   
            ...
            <select class="form-control" id="question_type" name="question_type" required style="width:300px;">
        ...
        <div class="form-group col-lg-12" style="margin-bottom: 20px;">   
            <label for="question" style="font-size: 20px;">Question: </label>
             <textarea id="question" class="form-control"  name="question" value="<?=$question;?>" style="width: 100%;" rows="5" required></textarea>
        </div>

        <div class="form-group col-lg-12" style="margin-bottom: 20px;">   
            <label for="op1" style="font-size: 20px;">Option 1: </label>
            <input type="text" id="op1" name="op1" class="form-control" value="<?=$op1;?>" size="128" required>
        </div>
        <div class="form-group col-lg-12" style="margin-bottom: 20px;">   
            <label for="op2" style="font-size: 20px;">Option 2: </label>
            <input type="text" id="op2" name="op2" size="128" class="form-control" value="<?=$op2;?>" required>
        </div>
        <div class="form-group col-lg-12" style="margin-bottom: 20px;">   
            <label for="op3" style="font-size: 20px;">Option 3: </label>
            <input type="text" id="op3" name="op3" size="128" class="form-control" value="<?=$op3;?>" required>
        </div>
        <div class="form-group col-lg-12" style="margin-bottom: 20px;">   
            <label for="op4" style="font-size: 20px;">Option 4: </label>
            <input type="text" id="op4" name="op4" size="128" class="form-control" value="<?=$op4;?>" required>
        </div> 
    ...
    <div class="form-group col-lg-12" style="color: #076cb0; margin-bottom: 20px; margin-top: 20px;">
                <label for="supporting_img" style="font-size: 20px;">Upload Supporting image :&nbsp;
                    ...
                    ?>
                    &nbsp;&nbsp; &nbsp;&nbsp;
                    <input type="file" name="userImage" class="form-control" id="first_name" placeholder="upload supporting iamge" style="width: 800px; margin-left: 40px;">
                     <?php } ?>
         </div>
